...
* **Controles de la Grúa:** La cabina giratoria (Q/E), el ángulo de elevación del brazo (R/F) y la extensión del brazo (T/G) se controlan de forma independiente. La extensión está limitada entre 2.0 y 8.0 unidades.
